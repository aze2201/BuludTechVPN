...
CompoundButton.OnCheckedChangeListener, DialogInterface.OnClickListener {
	...
	protected void onResume() {
		...
		try {
			...
			mAlert.show();
			mAlert.getButton(DialogInterface.BUTTON_NEGATIVE).setTextColor(ContextCompat.getColor(this,R.color.colorDialogBtn));
			mAlert.getButton(DialogInterface.BUTTON_POSITIVE).setTextColor(ContextCompat.getColor(this,R.color.colorDialogBtn));
