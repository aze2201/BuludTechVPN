...
public class LaunchVPN extends Activity {
    ...
    protected void startVpnFromIntent() {
        ...
        if (Intent.ACTION_MAIN.equals(action)) {
            ...
            if (profileToConnect == null) {
                ...
                loadSettingsForStartingVPN(mSelectedProfile);
                launchVPN();
            }
        }
    }

    private void loadSettingsForStartingVPN(VpnProfile vpnProfile){
        boolean enableAll = Utils.getPref(DashBoard.PREF_ENABLED_ALL, true, this);
        ...
        HashSet<String> selectedApps = Utils.getPackageNamesFromString(tickedApps);
        if(excludeThisApp){
            if(enableAll){
        ...
        if(!enableAll && selectedApps.isEmpty()){
            ...
            if(excludeThisApp)
                selectedApps.add(getString(R.string.package_name));
            vpnProfile.mAllowedAppsVpn = selectedApps;
        }else{
            vpnProfile.mAllowedAppsVpnAreDisallowed = enableAll;
            vpnProfile.mAllowedAppsVpn = selectedApps;
        }
    }
    ...
    private void askForPW(final int type) {
        ...
        dialog.create().show();
        android.app.AlertDialog d = dialog.create();
        d.show();
        d.getButton(DialogInterface.BUTTON_NEGATIVE).setTextColor(ContextCompat.getColor(this,R.color.colorDialogBtn));
        d.getButton(DialogInterface.BUTTON_POSITIVE).setTextColor(ContextCompat.getColor(this,R.color.colorDialogBtn));
    }
    ...
    void showConfigErrorDialog(int vpnok) {
        ...
        android.app.AlertDialog dialog = d.create();
        dialog.show();
