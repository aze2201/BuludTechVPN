...
import tk.usagis2.BuludTechVPN.Adapters.FavoritesAdapter;
import tk.usagis2.BuludTechVPN.R;

/**
 * Created by UsagiS2 on 24/03/2016.
 */
public class FavoritesFragment extends Fragment implements IVPNFragmentCallbacksForAdapter, IVPNFragmentCallbacksForActivity{
    public static final int KEY_CODE_CONNECT = 6;
    public static final int KEY_CODE_EDIT = 7;
    public static final int KEY_CODE_SHARE = 8;
    public static final int KEY_CODE_DELETE = 9;
    public static final int KEY_CODE_CONNECT_THIS = 10;
    public static final int KEY_CODE_CONNECT_3RD = 11;
    public static final int KEY_CODE_SAVE_TO_SD = 12;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = v.findViewById(R.id.recycler_view_favorites);
        ...
        // Adapter:
        adapter = new FavoritesAdapter(getContext(), callbacks.getVPNClasses(DashBoard.FAVORITES), this);
    ...
    public void refreshData(){
        adapter.setDataSet(callbacks.getVPNClasses(DashBoard.FAVORITES));
    ...
    public void onClickToButton(int position, int keyCode) {
        switch (keyCode){
            ...
            case KEY_CODE_DELETE:
                callbacks.deleteVPN(adapter.getDataSetAtPosition(position));
                closeOpenedView();
                break;
            case KEY_CODE_EDIT:
                callbacks.editVPN(adapter.getDataSetAtPosition(position));
                //closeOpenedView();
                break;
